...
func init() {
	os.Setenv("APP_ID", "bf4de8166f374b36968c841f91cbfa9f")
	os.Setenv("APP_CERTIFICATE", "007eJxTYLi1ecn+vwd87ofPyehWee6c/TZF97Kor888EZGXxceX3X2kwJCUZpKSamFoZpZmbG6SZGxmaWaRbGFimGZpmJyUlmiZlvD/VFpDICPDFb1eRkYGCATxuRhKUotLMvPSDY2MGRgABPEkdQ==")
